    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
        ...
        <div className="prose prose-neutral mt-10 max-w-none dark:prose-invert [&_h2]:mt-10 [&_h2]:text-xl [&_h2]:font-semibold [&_h3]:mt-6 [&_h3]:text-lg [&_h3]:font-medium">
          <h2>1. Overview</h2>
          <p>
            Stroby (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) operates the website stroby.ai and related services (the &ldquo;Service&rdquo;). This Privacy Policy explains how we collect, use, disclose, and protect your personal information when you use our Service.
          </p>
          <p>
