...
const BUSINESS_STEPS: Step[] = [
  ...
  { question: "What's the primary niche you're targeting?", field: "primary_niche", inputType: "select", options: NICHES },
  { question: "Describe your niche briefly.", field: "custom_niche", inputType: "text", placeholder: "e.g., Pet care, Automotive, Gaming...", conditionField: "primary_niche", conditionValue: "Other" },
