/**
 * WhatsAppCTA — the "message Stroby on WhatsApp" call-to-action with
 * the Open WhatsApp button and a scannable QR code.
 *
 * Lifted out of the homepage so the contact page (and other pages
 * that want this) can reuse it. The headline can be overridden via
 * the `headline` prop for context-specific copy.
 *
...
export function WhatsAppCTA({
  headline = "Or message Stroby directly on WhatsApp",
}: {
  headline?: string;
}) {
  return (
